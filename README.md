...
路线使用spline设置如图  
<a name="UIImg"></a>
![7](https://github.com/Aptal/FPSDemo/blob/main/HomeworkScreenshot/7Homework/7-1-1.png?raw=true)  

NPC巡航时会增加疲惫值（Fatigue），达到阈值随机找路线内某点休息，然后重置疲惫值
<a name="UIImg"></a>
![7](https://github.com/Aptal/FPSDemo/blob/main/HomeworkScreenshot/7Homework/7-1-2.png?raw=true)

巡航移动动画展示
<a name="UIImg"></a>
![7](https://github.com/Aptal/FPSDemo/blob/main/HomeworkScreenshot/7Homework/7-1-3.png?raw=true)

#### NPC休息展示

休息动画展示
<a name="UIImg"></a>
![7](https://github.com/Aptal/FPSDemo/blob/main/HomeworkScreenshot/7Homework/7-2.png?raw=true)

#### NPC与玩家交互

通过PawnSensing判断前方是否有玩家，展示UI并给玩家补充子弹  
<a name="UIImg"></a>
![7](https://github.com/Aptal/FPSDemo/blob/main/HomeworkScreenshot/7Homework/7-3-1.png?raw=true)
